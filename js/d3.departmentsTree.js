...
d3.chart.architectureTree = function() {
    ...
    var updateData = function(container, nodes, links) {
        ...
        node.append("circle")
            .attr("r", function(d) { return 3.5 * (d.size || 1); })
            ...
            .style('fill', function(d) {
                if (d.children.length > 0 || !d.details || !d.details.prerequisite_possible_paths || d.details.prerequisite_possible_paths.length === 0) return '#fff';
                return d3.scale.linear()
                    .domain([1, 0])
                    .range(["steelblue", "red"])(typeof d.satisfaction !== "undefined" ? d.satisfaction : 1);
            });
        ...
        node.append("text")
            ...
            .text(function(d) {
                return d.text !== undefined ? d.text : d.name;
            });
    };
